<footer id="footer" class="footer" style="background: #f9f9f9; padding: 30px 0; border-top: 1px solid #e0e0e0;">
    <div class="container text-center">
        ...
        <ul class="footer-links list-unstyled d-flex justify-content-center" style="gap: 24px; padding: 0; margin-bottom: 10px;">
            ...
            <li><a href="#about" style="color: #555; text-decoration: none; font-size: 14px;">About</a></li>
            <li><a href="" style="color: #555; text-decoration: none; font-size: 14px;">Services</a></li>
            <li><a href="#contact" style="color: #555; text-decoration: none; font-size: 14px;">Contact</a></li>
        </ul>

        <p style="font-size: 13px; color: #aaa; margin: 0;">© 2025 <strong>Learnify</strong>. All Rights Reserved.</p>
    </div>
</footer>