...
<header id="header" class="header d-flex align-items-center fixed-top shadow"
  style="background: linear-gradient(135deg, #00c6ff, #0072ff); padding: 10px 0;">
  ...
  <section class="dashboard-section py-5">
    <div class="container">
      ...
      <h1 class="section-title text-center mb-5 animate__animated animate__fadeInDown"
        ...
        <span style="color: #00c6ff;">Edit</span> Materi
      </h1>
              ...
              <form id="materiForm" action="/admin/update/<?= $materi['id']; ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                  ...
                  <textarea id="deskripsi" name="deskripsi"
                    ...
                    rows="5" placeholder="Tulis deskripsi materi..."><?= old('deskripsi', $materi['deskripsi']); ?></textarea>
                  <div class="invalid-feedback">
                ...
                <div class="mb-4">
                  ...
                  <input type="text" id="video_url" name="video_url"
                    ...
                    placeholder="Contoh: dQw4w9WgXcQ" value="<?= old('video_url', $materi['video_url']); ?>">
                  <div class="invalid-feedback">
                ...
                <div class="mb-4">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <img id="preview-img" src="/assets/img/<?= $materi['gambar']; ?>"
                ...
                <div class="d-flex justify-content-between mt-5">
                  <a href="/admin/detail/<?= $materi['slug']; ?>" class="btn btn-outline-primary rounded-pill px-4">
